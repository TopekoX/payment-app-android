...
public class  FirebaseHandleMessagingService extends FirebaseMessagingService {
    ...
    /**
     * see more: https://firebase.google.com/docs/cloud-messaging/android/receive
     * @param remoteMessage
     */
    @Override
    ...
    private void sendNotification(String from, String title, String body) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(FirebaseHandleMessagingService.this.getApplicationContext(), from + " -> " + title +
